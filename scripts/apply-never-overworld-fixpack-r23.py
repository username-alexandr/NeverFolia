...
Extends FIELD-R22 with strict ocean-connected cave flooding. R23 preserves
prospective OCEAN_FLOOR_WG seam seeds but removes proximity-only flooding of
large dry cave components.
"""
