...
class Tests(unittest.TestCase):
    ...
    def test_flood_calls_exactly_once(self):
        P.apply(self.folia);s=(self.folia/P.JAVA/P.FLOOD).read_text();self.assertEqual(s.count('NeverOverworldOreScarcityFieldR10.apply'),1);self.assertEqual(s.count('NeverOverworldSubmergedRemnants.apply'),1)
