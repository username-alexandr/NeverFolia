...
Changes only new-generation native code: candidate-tree admission, 25% final
ore retention, and persisted piece-wise mineshaft flood protection. Existing
worlds/locks/datapacks are never modified by this installer.
"""
...
def main():
    ...
    print('[FIELD-R12] candidate standing trees; 25% final ore retain; per-piece dry mines installed')
